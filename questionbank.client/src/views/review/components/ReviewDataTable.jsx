...
import { getAllReviewerQuestion } from "../../../apiClient/questionFeedBackApi.js";
...
const ReviewDataDataTable = (props) => {
  ...
  useEffect(() => {
    ...
    const getQuestionList = async () => {
      const result = await getAllReviewerQuestion(selectedOption.status);
  ...
  return (
    <>
      ...
      <ReadOnlyQuestion
        ...
        setModalVisible={handleClose}
        questionId={questionId}
        ownQuestion={selectedQuestion.status != 2}
        viewerType={questionViewerType.reviewer}
        selectedQuestion={selectedQuestion}
        readOnlyComment={selectedQuestion.status != 2}
      />
    </>
  );
};

export default ReviewDataDataTable;
