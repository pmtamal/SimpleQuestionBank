...
namespace QuestionBank.DataManagement.Migrations
{
    ...
    [Migration("20240521123444_FeedBackCycleCompleted")]
    partial class FeedBackCycleCompleted
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuestionBank.Persistence.Entity.QuestionFeedBack", b =>
                {
                    ...
                    b.Property<bool>("IsFeedBackCycleCompleted")
                        .HasColumnType("boolean");

                    b.Property<DateTime>("LastFeedBackSubmittedOn")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("QuestionBank.Persistence.Entity.UserTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("QuestionBank.Persistence.Entity.QuestionFeedBackComment", b =>
                {
                    b.HasOne("QuestionBank.Persistence.Entity.Question", "Question")
                        .WithMany("questionFeedBackComments")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("QuestionBank.Persistence.Entity.Question", b =>
                {
                    ...
                    b.Navigation("questionFeedBackComments");
                });
